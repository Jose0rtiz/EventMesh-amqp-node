...
const EC = Object.freeze({
    ...
    DECODE_PACKET_UNEXPECTED     : '[108] protocol error, unexpected control packet received, type %s',
    DECODE_PACKET_ID_UNEXPECTED  : '[109] protocol error, internal, failed to lookup packet by packetID %s',
    DECODE_PACKET_ID_MISMATCH    : '[110] protocol error, unexpected control packet received, type "%s", packet id "%s"',
